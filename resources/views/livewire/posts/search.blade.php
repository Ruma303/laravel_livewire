<div class="flex space-x-2 items-center">
    <input
        type="text"
        wire:model.live.debounce="search_post"
    ...
    @if ($search_post)
        <button
            ...
            class="text-white p-1 bg-gray-500 rounded-md hover:scale-105 hover:transition-all mb-2 shadow-md shadow-gray-200 h-fit">
            Reset
        </button>
